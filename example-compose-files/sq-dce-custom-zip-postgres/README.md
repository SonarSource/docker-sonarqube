...
11:33 sonarqube-datacenter-2026.5.0.132233.zip
11:33 unrestricted_client_body_size.conf
```

You need to specify the SonarQube Server version that will be used either with an export like this `export SONARQUBE_VERSION=2026.5.0.132233` or by changing the docker-compose file.
