...
11:33 sonarqube-datacenter-2025.4.9.131983.zip
11:33 unrestricted_client_body_size.conf
```

You need to specify the SonarQube Server version that will be used either with an export like this `export SONARQUBE_VERSION=2025.4.9.131983` or by changing the docker-compose file.
